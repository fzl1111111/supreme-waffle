				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 电器商城 -->
							<div><span>电器商城</span></div>
							<table_digital_mall v-if="$check_action('/digital_mall/table','get')"></table_digital_mall>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_digital_mall from "../../components/diy/table_digital_mall.vue";
	export default {
		data() {
			return {
			};
