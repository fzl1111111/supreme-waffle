<template>
	<div class="diy_details page_digital_mall" id="digital_mall_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_digital_mall'>
							<div_digital_mall :obj="obj"></div_digital_mall>
...
<script>
	import div_digital_mall from "@/components/diy/div_digital_mall.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/digital_mall/set?digital_mall_id=' + obj["digital_mall_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.digital_mall_id;
				}
			},
			/**
			 * 初始化收藏状态
