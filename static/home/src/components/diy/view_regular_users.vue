			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户性别" prop="user_gender">
					...
					<div v-else-if="$check_field('get','user_gender')">{{form_sub['user_gender']}}</div>
								...
								<el-col v-if="user_group === '管理员' || $check_field('get','user_phone_number') || $check_field('add','user_phone_number') || $check_field('set','user_phone_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="用户电话" prop="user_phone_number">
												<el-input id="user_phone_number" v-model="form_sub['user_phone_number']" placeholder="请输入用户电话"
							  v-if="user_group === '管理员' || (form_sub['regular_users_id'] && $check_field('set','user_phone_number')) || (!form_sub['regular_users_id'] && $check_field('add','user_phone_number'))"></el-input>
					<div v-else-if="$check_field('get','user_phone_number')">{{form_sub['user_phone_number']}}</div>
											</el-form-item>
			</el-col>
