...
export default {
  ...
  methods: {
    ...
    get_obj_after(json, func) {
      ...
      if (json.result.obj["the_date_of_issuance"] == "0000-00-00") {
        json.result.obj["the_date_of_issuance"] = null;
      }
      if (parseInt(json.result.obj["the_date_of_issuance"]) > 9999) {
        json.result.obj["the_date_of_issuance"] = this.$toTime(parseInt(json.result.obj["the_date_of_issuance"]), "yyyy-MM-dd")
      }
