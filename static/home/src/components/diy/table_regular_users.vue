      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                ...
                <el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
                                                      <el-button v-if="user_group == '管理员' || $check_action('/regular_users/table','add') || $check_action('/regular_users/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
                  ...
                  <el-table-column prop="username" label="用户名" width="120">
                        ...
                        <el-table-column fixed prop="nickname" label="昵称">
                               ...
                               v-if="user_group == '管理员' || $check_field('get','user_gender')" min-width="200">
                                              ...
                                              <el-table-column prop="user_phone_number" @sort-change="$sortChange" label="用户电话"
                               v-if="user_group == '管理员' || $check_field('get','user_phone_number')" min-width="200">
                                </el-table-column>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/regular_users/table','set') || $check_action('/regular_users/view','set') || $check_action('/regular_users/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >
